...
@WebServlet("/PinExport")
public class PinExport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Logger LOG = Logger.getLogger(PinExport.class.getName());
...
LOG.log(Level.INFO,"PinExport userId:{0} pinDigit:{1} pinAmount:{2} jobId:{3}",new Object[]{userId,pinDigit,pinAmount,jobId});
